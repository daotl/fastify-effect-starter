...
declare type var_463c6087eb7e11edbf11292267db50c0λFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
> = $.$expr_Function<
  _std.$number, $.cardutil.overrideLowerBound<$.Cardinality.One, 'Zero'>
>;
declare type var_463c6087eb7e11edbf11292267db50c0λFuncExpr2<
 ...
 */
declare function var_463c6087eb7e11edbf11292267db50c0<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
>(
  vals: P1,
): var_463c6087eb7e11edbf11292267db50c0λFuncExpr<P1>;
/**
 * Return the sample variance of the input set.
 */
declare function var_463c6087eb7e11edbf11292267db50c0<
...
>(
  vals: P1,
): var_463c6087eb7e11edbf11292267db50c0λFuncExpr2<P1>;
...
declare type __defaultExports = {
  "var": typeof var_463c6087eb7e11edbf11292267db50c0;
