...
type get_versionλFuncExpr = $.$expr_Function<$.NamedTupleType<{
    major: _std.$int64;
    minor: _std.$int64;
    stage: $VersionStage;
    stage_no: _std.$int64;
...
type get_version_as_strλFuncExpr = $.$expr_Function<_std.$str, $.Cardinality.One>;
/**
 * Return the server version as a string.
 */
declare function get_version_as_str(): get_version_as_strλFuncExpr;
type get_instance_nameλFuncExpr = $.$expr_Function<_std.$str, $.Cardinality.One>;
/**
 * Return the server instance name.
 */
declare function get_instance_name(): get_instance_nameλFuncExpr;
type get_transaction_isolationλFuncExpr = $.$expr_Function<$TransactionIsolation, $.Cardinality.One>;
/**
 * Return the isolation level of the current transaction.
 */
declare function get_transaction_isolation(): get_transaction_isolationλFuncExpr;
type get_current_databaseλFuncExpr = $.$expr_Function<_std.$str, $.Cardinality.One>;
/**
