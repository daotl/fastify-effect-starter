...
declare type get_pg_type_for_edgedb_type_b9a4371126c411ee903613e306fa5342λFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$uuid>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>,
  P3 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$uuid>> | undefined,
  P4 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>> | undefined,
> = $.$expr_Function<
  _std.$number, $.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>, $.cardutil.optionalParamCardinality<P3>>, $.cardutil.optionalParamCardinality<P4>>
>;
declare function get_pg_type_for_edgedb_type_b9a4371126c411ee903613e306fa5342<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$uuid>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>,
  P3 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$uuid>> | undefined,
  P4 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>> | undefined,
>(
  ...
  elemid?: P3,
  sql_type?: P4,
): get_pg_type_for_edgedb_type_b9a4371126c411ee903613e306fa5342λFuncExpr<P1, P2, P3, P4>;
...
declare type __defaultExports = {
  ...
  "_get_pg_type_for_edgedb_type": typeof get_pg_type_for_edgedb_type_b9a4371126c411ee903613e306fa5342
};
