...
type to_local_datetimeλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>> | undefined> = $.$expr_Function<$local_datetime, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.optionalParamCardinality<P2>>>;
type to_local_datetimeλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$datetime>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>> = $.$expr_Function<$local_datetime, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
...
type to_local_dateλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>> | undefined> = $.$expr_Function<$local_date, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.optionalParamCardinality<P2>>>;
type to_local_dateλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$datetime>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>> = $.$expr_Function<$local_date, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
...
type to_local_timeλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>> | undefined> = $.$expr_Function<$local_time, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.optionalParamCardinality<P2>>>;
type to_local_timeλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$datetime>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>> = $.$expr_Function<$local_time, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
...
type to_relative_durationλFuncExpr<NamedArgs extends {
...
type to_date_durationλFuncExpr<NamedArgs extends {
    "years"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>;
    "months"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>;
    "days"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>;
...
type time_getλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$local_time>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>> = $.$expr_Function<_std.$number, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
/**
...
type date_getλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$local_date>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>> = $.$expr_Function<_std.$number, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
/**
...
type duration_normalize_hoursλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$relative_durationλICastableTo>>> = $.$expr_Function<$relative_duration, $.cardutil.paramCardinality<P1>>;
/**
...
type duration_normalize_daysλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$date_duration>>> = $.$expr_Function<$date_duration, $.cardutil.paramCardinality<P1>>;
type duration_normalize_daysλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$relative_durationλICastableTo>>> = $.$expr_Function<$relative_duration, $.cardutil.paramCardinality<P1>>;
/**
