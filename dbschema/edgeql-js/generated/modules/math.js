...
function var_463c6087eb7e11edbf11292267db50c0(...args) {
...
function abs(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('math::abs', args, _.spec, [
    {args: [{typeId: "34d7f100-eb7e-11ed-bb44-7318fdcf012d", optional: false, setoftype: false, variadic: false}], returnTypeId: "34d7f100-eb7e-11ed-bb44-7318fdcf012d"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
const __defaultExports = {
  "var": var_463c6087eb7e11edbf11292267db50c0,
  "var_pop": var_pop,
  "abs": abs,
  "ceil": ceil,
  "floor": floor,
