...
import type { $expr_PolyShapeElement, $scopify, Expression, LinkDesc, ObjectType, ObjectTypeExpression, ObjectTypePointers, ObjectTypeSet, PrimitiveTypeSet, PropertyDesc, ScalarType, stripSet, TypeSet, BaseType, ExclusiveTuple, orLiteralValue } from "./typesystem.mjs";
import type { $expr_PathLeaf, $linkPropify, ExpressionRoot } from "./path.mjs";
import type { anonymizeObject } from "./casting.mjs";
import { scalarLiterals, literalToScalarType } from "./castMaps.mjs";
