...
import type { typeutil, Cardinality, ExpressionKind } from "edgedb/dist/reflection/index.js";
...
export type SomeType = ScalarType | EnumType | ArrayType | TupleType | ObjectType | NamedTupleType | RangeType;
...
export type PrimitiveType = ScalarType | EnumType | TupleType | NamedTupleType | ArrayType | RangeType;
...
type ArrayTypeToTsType<Type extends ArrayType> = BaseTypeToTsType<Type["__element__"]>[];
...
export type getPrimitiveBaseType<T extends BaseType> = T extends ScalarType ? ScalarType<T["__name__"], T["__tstype__"]> : T;
...
export type NonArrayType = ScalarType | EnumType | ObjectType | TupleType | NamedTupleType | RangeType;
